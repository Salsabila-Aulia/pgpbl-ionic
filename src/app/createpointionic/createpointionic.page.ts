...
@Component({
  selector: 'app-createpointionic',
  templateUrl: './createpointionic.page.html',
  styleUrls: ['./createpointionic.page.scss'],
  standalone: false,
})
export class CreatepointionicPage implements OnInit {
  map!: L.Map;
